      ...
      <div className="flex justify-center">
        <h1>Shopping Cart page</h1>
          <div className="card flex flex-col justify-center items-center ">
            ...
            <h2 className="self-start font-bold  text-2xl mb-2">{vinyleName}</h2>
            ...
            <div className="label-cat mt-4 w-full flex  justify-between items-center">
                    ...
                    <button className="add-btn text-white font-bold py-2 px-4 rounded">ADD TO CART</button>
            </div>
